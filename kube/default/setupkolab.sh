...
sinksh create resource type sink.dav identifier kolabdav server kolab/iRony/addressbooks/john.doe%40example.org  username john.doe@example.org  password Welcome2KolabSystems
